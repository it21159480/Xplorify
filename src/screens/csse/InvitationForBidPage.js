...
const InvitationForBidPage = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
            <Provider>
                ...
                <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'white', textAlign:'center',marginTop:70 }}>Invitation For Bid</Text>
                </View>
...
export default InvitationForBidPage;